...
public class UserEntity extends BaseEntity {
    ...
    public UserEntity(String email, String phone, String name, String password) {
        this.email = email;
        this.phone = phone;
        this.name = name;
    ...
    // createInstance
    public UserEntity(String email, String phone, String name, String password, AuthorityEntity authorityEntity) {
        this.email = email;
        this.phone  = phone;
        this.name  = name;
        this.password   = password;
